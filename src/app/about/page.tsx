      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className='max-w-4xl mx-auto mb-16'>
          ...
          <p className='text-lg text-gray-300 mb-6 text-center'>
            I'm Ajmal Hussain, a Full Stack Developer with 2 years of experience
            in Javascript & React. I blend creativity with functionality to
            craft engaging designs. Choosing me means transforming ideas into
            results. Let's collaborate to enhance your digital presence. Reach
            me at my email to discuss your project.
          </p>
        </div>
